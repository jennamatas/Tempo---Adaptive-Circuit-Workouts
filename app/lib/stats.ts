// Pure dashboard aggregation — no network, no Supabase, no React.
// Computed from the session rows so it can be unit-tested in isolation
// (see app/__tests__/stats.test.ts).
